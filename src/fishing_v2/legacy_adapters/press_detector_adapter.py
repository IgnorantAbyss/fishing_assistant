        ...
        try:
            ...
            return PressObservation(
                ...
                evidence={
                    ...
                    "clean_frame_eligible": bool(result.get("clean_frame_eligible", False)),
                    "input_effect_detected": bool(result.get("input_effect_detected", False)),
                    "input_effect_reason": str(result.get("input_effect_reason", "")),
                    "selected_for_sequence": bool(result.get("selected_for_sequence", False)),
                    ...
                    "arrow_sequence_ready": bool(result.get("debug", {}).get("arrow_sequence_ready", False)),
